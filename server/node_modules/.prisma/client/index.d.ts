...
/**
  ...
  /**
   * `prisma.anzUser`: Exposes CRUD operations for the **anzUser** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more AnzUsers
    * const anzUsers = await prisma.anzUser.findMany()
    * ```
    */
  get anzUser(): Prisma.anzUserDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateAnzUser = {
    _count: AnzUserCountAggregateOutputType | null
    _avg: AnzUserAvgAggregateOutputType | null
    _sum: AnzUserSumAggregateOutputType | null
    _min: AnzUserMinAggregateOutputType | null
    _max: AnzUserMaxAggregateOutputType | null
  }

  export type AnzUserAvgAggregateOutputType = {
    anzUser: number | null
    anzUserId: number | null
  }

  export type AnzUserSumAggregateOutputType = {
    anzUser: number | null
    anzUserId: number | null
  }

  export type AnzUserMinAggregateOutputType = {
    anzUser: number | null
    anzUserId: number | null
  }

  export type AnzUserMaxAggregateOutputType = {
    anzUser: number | null
    anzUserId: number | null
  }

  export type AnzUserCountAggregateOutputType = {
    anzUser: number
    anzUserId: number
    _all: number
  }
  ...
  export type AnzUserAvgAggregateInputType = {
    anzUser?: true
    anzUserId?: true
  }

  export type AnzUserSumAggregateInputType = {
    anzUser?: true
    anzUserId?: true
  }

  export type AnzUserMinAggregateInputType = {
    anzUser?: true
    anzUserId?: true
  }

  export type AnzUserMaxAggregateInputType = {
    anzUser?: true
    anzUserId?: true
  }

  export type AnzUserCountAggregateInputType = {
    anzUser?: true
    anzUserId?: true
    _all?: true
  }

  export type AnzUserAggregateArgs = {
    /**
     * Filter which anzUser to aggregate.
     * 
    **/
    where?: anzUserWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of anzUsers to fetch.
     * 
    **/
    orderBy?: Enumerable<anzUserOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
     * 
    **/
    cursor?: anzUserWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` anzUsers from the position of the cursor.
     * 
    **/
    take?: number
    /**
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned anzUsers
    **/
    _count?: true | AnzUserCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    _avg?: AnzUserAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: AnzUserSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: AnzUserMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: AnzUserMaxAggregateInputType
  }

  export type GetAnzUserAggregateType<T extends AnzUserAggregateArgs> = {
        [P in keyof T & keyof AggregateAnzUser]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateAnzUser[P]>
      : GetScalarType<T[P], AggregateAnzUser[P]>
  }
  ...
  export type AnzUserGroupByArgs = {
    where?: anzUserWhereInput
    orderBy?: Enumerable<anzUserOrderByWithAggregationInput>
    by: Array<AnzUserScalarFieldEnum>
    having?: anzUserScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: AnzUserCountAggregateInputType | true
    _avg?: AnzUserAvgAggregateInputType
    _sum?: AnzUserSumAggregateInputType
    _min?: AnzUserMinAggregateInputType
    _max?: AnzUserMaxAggregateInputType
  ...
  export type AnzUserGroupByOutputType = {
    anzUser: number
    anzUserId: number
    _count: AnzUserCountAggregateOutputType | null
    _avg: AnzUserAvgAggregateOutputType | null
  ...
  type GetAnzUserGroupByPayload<T extends AnzUserGroupByArgs> = Promise<
    Array<
      PickArray<AnzUserGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof AnzUserGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], AnzUserGroupByOutputType[P]>
            : GetScalarType<T[P], AnzUserGroupByOutputType[P]>
        }
      >
    >
  ...
  export type anzUserSelect = {
    anzUser?: boolean
    anzUserId?: boolean
  }

  export type anzUserGetPayload<
    S extends boolean | null | undefined | anzUserArgs,
    U = keyof S
      > = S extends true
        ? anzUser
    : S extends undefined
    ? never
    : S extends anzUserArgs | anzUserFindManyArgs
    ?'include' extends U
    ? anzUser 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof anzUser ?anzUser [P]
  : 
     never
  } 
    : anzUser
  ...
  type anzUserCountArgs = Merge<
    Omit<anzUserFindManyArgs, 'select' | 'include'> & {
      select?: AnzUserCountAggregateInputType | true
    }
  >

  export interface anzUserDelegate<GlobalRejectSettings> {
    /**
     * Find zero or one AnzUser that matches the filter.
     * @param {anzUserFindUniqueArgs} args - Arguments to find a AnzUser
     * @example
     * // Get one AnzUser
     * const anzUser = await prisma.anzUser.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends anzUserFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, anzUserFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'anzUser'> extends True ? CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>> : CheckSelect<T, Prisma__anzUserClient<anzUser | null >, Prisma__anzUserClient<anzUserGetPayload<T> | null >>

    /**
     * Find the first AnzUser that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {anzUserFindFirstArgs} args - Arguments to find a AnzUser
     * @example
     * // Get one AnzUser
     * const anzUser = await prisma.anzUser.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends anzUserFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, anzUserFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'anzUser'> extends True ? CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>> : CheckSelect<T, Prisma__anzUserClient<anzUser | null >, Prisma__anzUserClient<anzUserGetPayload<T> | null >>

    /**
     * Find zero or more AnzUsers that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {anzUserFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all AnzUsers
     * const anzUsers = await prisma.anzUser.findMany()
     * 
     * // Get first 10 AnzUsers
     * const anzUsers = await prisma.anzUser.findMany({ take: 10 })
     * 
     * // Only select the `anzUser`
     * const anzUserWithAnzUserOnly = await prisma.anzUser.findMany({ select: { anzUser: true } })
     * 
    **/
    findMany<T extends anzUserFindManyArgs>(
      args?: SelectSubset<T, anzUserFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<anzUser>>, PrismaPromise<Array<anzUserGetPayload<T>>>>

    /**
     * Create a AnzUser.
     * @param {anzUserCreateArgs} args - Arguments to create a AnzUser.
     * @example
     * // Create one AnzUser
     * const AnzUser = await prisma.anzUser.create({
     *   data: {
     *     // ... data to create a AnzUser
     *   }
     * })
     * 
    **/
    create<T extends anzUserCreateArgs>(
      args: SelectSubset<T, anzUserCreateArgs>
    ): CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>>

    /**
     * Create many AnzUsers.
     *     @param {anzUserCreateManyArgs} args - Arguments to create many AnzUsers.
     *     @example
     *     // Create many AnzUsers
     *     const anzUser = await prisma.anzUser.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends anzUserCreateManyArgs>(
      args?: SelectSubset<T, anzUserCreateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Delete a AnzUser.
     * @param {anzUserDeleteArgs} args - Arguments to delete one AnzUser.
     * @example
     * // Delete one AnzUser
     * const AnzUser = await prisma.anzUser.delete({
     *   where: {
     *     // ... filter to delete one AnzUser
     *   }
     * })
     * 
    **/
    delete<T extends anzUserDeleteArgs>(
      args: SelectSubset<T, anzUserDeleteArgs>
    ): CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>>

    /**
     * Update one AnzUser.
     * @param {anzUserUpdateArgs} args - Arguments to update one AnzUser.
     * @example
     * // Update one AnzUser
     * const anzUser = await prisma.anzUser.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends anzUserUpdateArgs>(
      args: SelectSubset<T, anzUserUpdateArgs>
    ): CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>>

    /**
     * Delete zero or more AnzUsers.
     * @param {anzUserDeleteManyArgs} args - Arguments to filter AnzUsers to delete.
     * @example
     * // Delete a few AnzUsers
     * const { count } = await prisma.anzUser.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends anzUserDeleteManyArgs>(
      args?: SelectSubset<T, anzUserDeleteManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Update zero or more AnzUsers.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {anzUserUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many AnzUsers
     * const anzUser = await prisma.anzUser.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends anzUserUpdateManyArgs>(
      args: SelectSubset<T, anzUserUpdateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Create or update one AnzUser.
     * @param {anzUserUpsertArgs} args - Arguments to update or create a AnzUser.
     * @example
     * // Update or create a AnzUser
     * const anzUser = await prisma.anzUser.upsert({
     *   create: {
     *     // ... data to create a AnzUser
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the AnzUser we want to update
     *   }
     * })
    **/
    upsert<T extends anzUserUpsertArgs>(
      args: SelectSubset<T, anzUserUpsertArgs>
    ): CheckSelect<T, Prisma__anzUserClient<anzUser>, Prisma__anzUserClient<anzUserGetPayload<T>>>

    /**
     * Count the number of AnzUsers.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {anzUserCountArgs} args - Arguments to filter AnzUsers to count.
     * @example
     * // Count the number of AnzUsers
     * const count = await prisma.anzUser.count({
     *   where: {
     *     // ... the filter for the AnzUsers we want to count
     *   }
     * })
    **/
    count<T extends anzUserCountArgs>(
      args?: Subset<T, anzUserCountArgs>,
    ): PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], AnzUserCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a AnzUser.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {AnzUserAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends AnzUserAggregateArgs>(args: Subset<T, AnzUserAggregateArgs>): PrismaPromise<GetAnzUserAggregateType<T>>

    /**
     * Group by AnzUser.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {AnzUserGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends AnzUserGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: AnzUserGroupByArgs['orderBy'] }
        : { orderBy?: AnzUserGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, AnzUserGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnzUserGroupByPayload<T> : Promise<InputErrors>
  }

  /**
   * The delegate class that acts as a "Promise-like" for anzUser.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__anzUserClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   * anzUser findUnique
   */
  export type anzUserFindUniqueArgs = {
    /**
     * Select specific fields to fetch from the anzUser
     * 
    **/
    select?: anzUserSelect | null
    /**
     * Throw an Error if a anzUser can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
     * Filter, which anzUser to fetch.
     * 
    **/
    where: anzUserWhereUniqueInput
  }
   ...
   * anzUser findFirst
   */
  export type anzUserFindFirstArgs = {
    /**
     * Select specific fields to fetch from the anzUser
     * 
    **/
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for anzUsers.
     * 
    **/
    cursor?: anzUserWhereUniqueInput
    /**
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of anzUsers.
     * 
    **/
    distinct?: Enumerable<AnzUserScalarFieldEnum>
  }
   ...
   * anzUser findMany
   */
  export type anzUserFindManyArgs = {
    /**
     * Select specific fields to fetch from the anzUser
     * 
    **/
    select?: anzUserSelect | null
    /**
     * Filter, which anzUsers to fetch.
     * 
    **/
    where?: anzUserWhereInput
    /**
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing anzUsers.
     * 
    **/
    cursor?: anzUserWhereUniqueInput
    /**
  ...
  export type anzUserCreateArgs = {
    ...
    **/
    select?: anzUserSelect | null
    /**
     * The data needed to create a anzUser.
     * 
    **/
    data: XOR<anzUserCreateInput, anzUserUncheckedCreateInput>
  }
   ...
   * anzUser createMany
   */
  export type anzUserCreateManyArgs = {
    /**
     * The data used to create many anzUsers.
     * 
    **/
    data: Enumerable<anzUserCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type anzUserUpdateArgs = {
    ...
    **/
    select?: anzUserSelect | null
    /**
     * The data needed to update a anzUser.
     * 
    **/
    data: XOR<anzUserUpdateInput, anzUserUncheckedUpdateInput>
    /**
     * Choose, which anzUser to update.
     * 
    **/
    where: anzUserWhereUniqueInput
  }
   ...
   * anzUser updateMany
   */
  export type anzUserUpdateManyArgs = {
    /**
     * The data used to update anzUsers.
     * 
    **/
    data: XOR<anzUserUpdateManyMutationInput, anzUserUncheckedUpdateManyInput>
    /**
     * Filter which anzUsers to update
     * 
    **/
    where?: anzUserWhereInput
  }
  ...
  export type anzUserUpsertArgs = {
    ...
    **/
    select?: anzUserSelect | null
    /**
     * The filter to search for the anzUser to update in case it exists.
     * 
    **/
    where: anzUserWhereUniqueInput
    /**
     * In case the anzUser found by the `where` argument doesn't exist, create a new anzUser with this data.
     * 
    **/
    create: XOR<anzUserCreateInput, anzUserUncheckedCreateInput>
    /**
     * In case the anzUser was found with the provided `where` argument, update it with this data.
     * 
    **/
    update: XOR<anzUserUpdateInput, anzUserUncheckedUpdateInput>
  }
  ...
  export type anzUserDeleteArgs = {
    ...
    **/
    select?: anzUserSelect | null
    /**
     * Filter which anzUser to delete.
     * 
    **/
    where: anzUserWhereUniqueInput
  }
   ...
   * anzUser deleteMany
   */
  export type anzUserDeleteManyArgs = {
    /**
     * Filter which anzUsers to delete
     * 
    **/
    where?: anzUserWhereInput
  }
  ...
  /**
   * anzUser without action
   */
  export type anzUserArgs = {
    /**
     * Select specific fields to fetch from the anzUser
     * 
    **/
  ...
  export const AnzUserScalarFieldEnum: {
    anzUser: 'anzUser',
    anzUserId: 'anzUserId'
  };

  export type AnzUserScalarFieldEnum = (typeof AnzUserScalarFieldEnum)[keyof typeof AnzUserScalarFieldEnum]
  ...
  export type anzUserWhereInput = {
    AND?: Enumerable<anzUserWhereInput>
    OR?: Enumerable<anzUserWhereInput>
    NOT?: Enumerable<anzUserWhereInput>
    anzUser?: IntFilter | number
    anzUserId?: IntFilter | number
  }

  export type anzUserOrderByWithRelationInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }

  export type anzUserWhereUniqueInput = {
    anzUserId?: number
  }

  export type anzUserOrderByWithAggregationInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
    _count?: anzUserCountOrderByAggregateInput
    _avg?: anzUserAvgOrderByAggregateInput
    _max?: anzUserMaxOrderByAggregateInput
    _min?: anzUserMinOrderByAggregateInput
    _sum?: anzUserSumOrderByAggregateInput
  }

  export type anzUserScalarWhereWithAggregatesInput = {
    AND?: Enumerable<anzUserScalarWhereWithAggregatesInput>
    OR?: Enumerable<anzUserScalarWhereWithAggregatesInput>
    NOT?: Enumerable<anzUserScalarWhereWithAggregatesInput>
    anzUser?: IntWithAggregatesFilter | number
    anzUserId?: IntWithAggregatesFilter | number
  }
  ...
  export type anzUserCreateInput = {
    anzUser: number
  }

  export type anzUserUncheckedCreateInput = {
    anzUser: number
    anzUserId?: number
  }

  export type anzUserUpdateInput = {
    anzUser?: IntFieldUpdateOperationsInput | number
  }

  export type anzUserUncheckedUpdateInput = {
    anzUser?: IntFieldUpdateOperationsInput | number
    anzUserId?: IntFieldUpdateOperationsInput | number
  }

  export type anzUserCreateManyInput = {
    anzUser: number
    anzUserId?: number
  }

  export type anzUserUpdateManyMutationInput = {
    anzUser?: IntFieldUpdateOperationsInput | number
  }

  export type anzUserUncheckedUpdateManyInput = {
    anzUser?: IntFieldUpdateOperationsInput | number
    anzUserId?: IntFieldUpdateOperationsInput | number
  }
  ...
  export type anzUserCountOrderByAggregateInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }

  export type anzUserAvgOrderByAggregateInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }

  export type anzUserMaxOrderByAggregateInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }

  export type anzUserMinOrderByAggregateInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }

  export type anzUserSumOrderByAggregateInput = {
    anzUser?: SortOrder
    anzUserId?: SortOrder
  }
